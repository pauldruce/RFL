            ...
            if (NOT Armadillo_FOUND AND NOT ARMADILLO_FOUND)
                message(STATUS "Armadillo not found or RFL_FETCH_ARMADILLO is enabled; fetching via FetchContent...")
                    include(FetchContent)
                        ...
                        if (NOT DEFINED RFL_ARMADILLO_GIT_TAG) if (DEFINED ARMADILLO_GIT_TAG)
                            set(RFL_ARMADILLO_GIT_TAG "${ARMADILLO_GIT_TAG}") else()
                                                    ...
                                                    set(CMAKE_POLICY_VERSION_MINIMUM 3.5 CACHE STRING "Minimum policy version for fetched dependencies" FORCE)
                                                        ...
                                                        if (APPLE)
                                                            set(ALLOW_OPENBLAS_MACOS ON CACHE BOOL "Allow detection of OpenBLAS on macOS" FORCE)
                                                                    ...
                                                                    set(OPENBLAS_PROVIDES_LAPACK ON CACHE BOOL "Assume OpenBLAS provides LAPACK on Windows" FORCE)
                                                                        endif()
                                                                            ...
                                                                            FetchContent_Declare(
                                                                                ...
                                                                                FetchContent_MakeAvailable(armadillo)
                                                                                            ...
                                                                                            if (TARGET armadillo) if (NOT TARGET Armadillo::Armadillo)
                                                                                                                    ...
                                                                                                                    set(ARMADILLO_LIBRARIES Armadillo::Armadillo)
                                                                                                                        set(ARMADILLO_FOUND TRUE)
                                                                                                                            elseif(ARMADILLO_FOUND OR Armadillo_FOUND)
                                                                                                                                set(ARMADILLO_FOUND TRUE) if (NOT TARGET Armadillo::Armadillo)
                                                                                                                                    add_library(Armadillo::Armadillo INTERFACE IMPORTED) if (ARMADILLO_INCLUDE_DIRS)
                                                                                                                                        target_include_directories(Armadillo::Armadillo INTERFACE ${ARMADILLO_INCLUDE_DIRS})
                                                                                                                                            endif() if (ARMADILLO_LIBRARIES)
                                                                                                                                                target_link_libraries(Armadillo::Armadillo INTERFACE ${ARMADILLO_LIBRARIES})
                                                                                                                                                    endif()
                                                                                                                                                        endif()
                                                                                                                                                            set(ARMADILLO_LIBRARIES Armadillo::Armadillo) else()
